...
const routes: Routes = [
{
  path: 'create-blueprint', component: CreateBluePrintComponent, canActivate: [ProgramsService, AuthGuard], pathMatch: 'full',
  data: {
...
{
    path: 'blueprint-list', component: BluePrintListComponent, canActivate: [ProgramsService, AuthGuard], pathMatch: 'full',
    data: {
      roles: 'programSourcingRole',
      telemetry: { env: 'sourcing-portal', type: telemetryPage.pageType.workflow, subtype: telemetryPage.pageSubtype.paginate,
      pageid: telemetryPage.pageId.sourcing.createProjectDetails, mode: telemetryPage.pageMode.create,
